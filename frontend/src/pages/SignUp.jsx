...
const SignUp = () => {
  ...
  {/* Signup Form */}
  <div className='flex flex-col items-center justify-center bg-[#240B42] shadow-2xl w-96 h-[490px] rounded-md z-10'>
    <h1 className='text-3xl font-bold text-white' style={{ marginTop: "10px", marginBottom: "50px" }}>SignUp</h1>
    ...
    <p className='text-white'>Already have an account? <Link to="/signIn" className='text-blue-700 hover:underline'>Go to SignIn</Link></p>
  </div>
</div>
</div>
  )
